        ...
        <div class="content_holesecion">
		    <div class="single-page d-flex flex-column">
			    <div class="single-page-heading single-page d-flex flex-column">
			        <a href="{{ $lang == 'en' ? url('/customers') : url('/no/kunder') }}"><img src="{{ asset('images/back-icon.png')}}" alt="icon"/></a>
                </div>
                    ...
                    <div class="imageupload log-setting-up">
                        ...
                        <div class="d-flex">
                            <label class="btn btn-file">
                                <img src="{{asset($customer->prof_image)}}" id="avatar"/>
                                <button class="btn up-img">@lang('member.upload_image')</button>
                                <input type="file" id="upload_file" name="image-file">
                            </label>
                            <label class="switch">
                                <input type="checkbox" id="image_access" {{ $customer->image_access == 1 ? 'checked' : '' }}>
                                <span class="slider"></span>
                                <span class="uncheck"></span>
                            </label>
                            <input type="hidden" id="checkbox_value" name="checkbox_value" value="{{$customer->image_access}}">
                ...
                <div class="page-setting d-flex flex-column">
                    ...
                    <div class="page-seting-content d-flex flex-column">
                        ...
                        <select id="industry_expertise" class="form-control" style="height: auto!important;">
                            ...
                            <option value="{{$data->category_name}}" {{ $customer->industry_expertise == $data->category_name ? 'selected="selected"' : '' }}>{{$data->category_name}}</option>
                            @endforeach 
                        </select>
                ...
                <div class="profile-uploader d-flex flex-column">
                    ...
                    <div class="profile-sec contact-sec d-flex flex-column">
                        ...
                        <label class="switch">
                            <input type="checkbox"  id="phone_checkbox" class="phone_checkbox" value='1' {{ $customer->phone_contact == 1 ? 'checked' : '' }}>
                            <span class="slider"></span>
                            <span class="uncheck"></span>
                        </label>
                        <label class="heading-t">@lang('admin.chat')</label>
                        <label class="switch">
                            <input type="checkbox" id="chat_checkbox" class="chat_checkbox" value='1' {{ $customer->chat_contact == 1 ? 'checked' : '' }}>
                            <span class="slider"></span>
                            <span class="uncheck"></span>
                        </label>
                        <label class="heading-t">@lang('admin.video')</label>
                        <label class="switch">
                            <input type="checkbox" id="video_checkbox" class="video_checkbox" value='1' {{ $customer->video_contact == 1 ? 'checked' : '' }}>
                            <span class="slider"></span>
                            <span class="uncheck"></span>
                        </label>
                ...
                <div class="page-setting d-flex flex-column">
                    ...
                    <div class="page-seting-content d-flex flex-column">
                        ...
                        <input type="text" id="company_name" class="company_name" value="{{$customer->company_name}}">
                        <div class="alert" id="company_name_error"></div>
                        <label>@lang('admin.invoice_email')</label>
                        <input type="text" id="invoice_mail" class="invoice_mail" value="{{$customer->invoice_mail}}">
                        <div class="alert" id="invoice_mail_error"></div>
                        <label>@lang('admin.first_name')</label>
                        <input type="text" id="company_first_name" class="company_first_name" value="{{$customer->invoice_first_name}}">
                        <div class="alert" id="company_first_name_error"></div>
                        <label>@lang('admin.last_name')</label>
                        <input type="text" id="company_last_name" class="company_last_name" value="{{$customer->invoice_last_name}}">
                        <div class="alert" id="company_last_name_error"></div>
                        <label>@lang('admin.address')</label>
                        <input type="text" id="address" class="address" value="{{$customer->invoice_address}}">
                        <div class="alert" id="address_error"></div>
                        <label>@lang('admin.zip_code')</label>
                        <input type="text" id="zip_code" class="zip_code" value="{{$customer->invoice_zip_code}}">
                        <div class="alert" id="zip_code_error"></div>
                        <label>@lang('admin.zip_place')</label>
                        <input type="text" id="zip_place" class="zip_place" value="{{$customer->invoice_zip_place}}">
...
<script>
    $(document).ready(function(){
        var temp = "{{$customer}}";
        temp = temp.replace(/&quot;/g, '"');
        var customer = JSON.parse(temp);
        if (!customer.prof_image) {
