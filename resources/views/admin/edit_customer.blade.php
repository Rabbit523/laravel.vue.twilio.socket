                    ...
                    <div class="imageupload log-setting-up">
                        ...
                        <div class="d-flex">
                            <label class="btn btn-file">
                                ...
                                <img src="{{asset($customer->profile->avatar)}}" id="avatar"/>
                                @else
                ...
                <div class="page-setting d-flex flex-column">
                    ...
                    <div class="page-seting-content d-flex flex-column">
                        ...
                        <select id="industry_expertise" class="form-control" style="height: auto!important;">
                            ...
                            <option value="{{$data->category_name}}" {{ $customer->profile->profession == $data->category_name ? 'selected="selected"' : '' }}>{{$data->category_name}}</option>
                            @endforeach 
                        </select>
...
<script>
	jQuery(function(){
		...
		new gotoconsult.Controllers.editCustomer(customer);
	});
</script>
@endsection